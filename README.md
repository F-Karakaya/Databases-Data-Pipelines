# 🚀 Databases & Data Pipelines: End-to-End Architecture
...
2.  **Storage Layer**:
    *   🐘 **PostgreSQL**: For high-fidelity sensor time-series data.
    *   🍃 **MongoDB**: For flexible user event logging.
    *   🔍 **Qdrant**: For semantic product embeddings.
